...
function BlogsCard({image, title, description, date, author}) {
  return (
    <Link to={`/blogs/${title}`} onClick={() => {
      ...
      <div className='p-4 shadow-lg transition-all duration-500 hover:shadow-xl'>
        <div className='overflow-hidden'>
          <img src={image} alt="" className='mx-auto h-[250] w-full object-cover transition-all duration-700 hover:skew-x-2 hover:scale-110'/>
        </div>
